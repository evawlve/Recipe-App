...
exports.seedFoods = seedFoods;
exports.addFoodConstraints = addFoodConstraints;
...
async function seedFoods() {
    ...
    for (const food of initialFoods) {
        ...
        const existing = await db_1.prisma.food.findFirst({
            where: {
                name: food.name,
                brand: food.brand
            }
...
async function addFoodConstraints() {
