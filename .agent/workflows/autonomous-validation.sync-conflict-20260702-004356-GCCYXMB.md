...
5. **If FDC candidate has higher score but lower rank:**
   ...
   - Open Food Facts (OFF) boost may be too aggressive, causing FDC to rank lower
   - Consider reducing `WEIGHTS.SOURCE_OFF` or adding FDC preference for this category
