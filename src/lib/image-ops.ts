...
export interface CompressImageOptions {
  maxDim?: number; // default 2048
  quality?: number; // default 0.82
  type?: "image/webp" | "image/jpeg"; // default "image/webp"
  squareCrop?: boolean; // for avatars
}
 ...
 */
export function generateCompressedFilename(originalName: string, ext: string): string {
