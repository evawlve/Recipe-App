...
const CATEGORY_EXCLUSIONS: CategoryExclusion[] = [
    ...
    // === NEW: Broad Herb, Spice, and Oil negative category guards ===
    {
        query: ['rosemary', 'thyme', 'oregano', 'basil', 'parsley', 'dill', 'sage', 'bay leaf', 'cilantro', 'star anise', 'ginger', 'pepper', 'salt', 'kosher salt', 'sea salt', 'celtic salt', 'cayenne pepper', 'black pepper', 'white pepper', 'cloves', 'clove', 'nutmeg', 'allspice', 'cardamom', 'cinnamon', 'avocado oil', 'olive oil'],
        excludeIfContains: ['crisps', 'cracker', 'crackers', 'chip', 'chips', 'bread', 'sauce', 'simmer', 'simmer sauce', 'dressing', 'marinade', 'dip', 'jute', 'vegetable', 'jute leaves', 'potherb', 'jelly', 'jam', 'spread', 'cookie', 'cookies', 'cake', 'candy', 'candies', 'cashew', 'cashews', 'nut', 'nuts', 'peanut', 'peanuts', 'almond', 'almonds', 'pecan', 'pecans', 'walnut', 'walnuts', 'mix', 'blend', 'chicken', 'pork', 'beef', 'fish', 'beans', 'potato', 'potatoes', 'spinach', 'squash', 'mackerel', 'buns', 'scallops', 'scallop'],
        skipIfQueryContains: ['crisps', 'cracker', 'crackers', 'chip', 'chips', 'bread', 'sauce', 'dressing', 'marinade', 'dip', 'spread', 'chicken', 'pork', 'beef', 'fish', 'mix', 'blend']
    },
    // === NEW: Workout supplements/pre-workouts vs candy/confectionery ===
    {
        query: ['pre-workout', 'workout supplement', 'protein powder', 'whey protein', 'whey'],
        excludeIfContains: ['candy', 'candies', 'lollipop', 'truffle', 'chewy', 'chocolate bar', 'twizzlers', 'straws', 'candy straws', 'sour straws'],
        skipIfQueryContains: ['candy', 'candies', 'straws']
    },
];
