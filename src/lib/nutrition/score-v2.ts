export type Goal = 'general'|'weight_loss'|'muscle_gain'|'maintenance';
...
const GOAL_TARGETS: Record<Goal, { p_pct:number; c_pct:number; f_pct:number }> = {
...
function to100(x:number){ return Math.round(100 * clamp01(x)); }
 ...
 */
export function scoreV2(inp: ScoreInput, goal: Goal) {
